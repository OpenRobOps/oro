...
const LocalizeIcon = ({ disabled }) => {
  if (disabled) {
    return (
      ...
      >
        <circle cx="8" cy="12" r="5.5" stroke="currentColor" strokeOpacity="0.3" />
        <circle cx="16" cy="12" r="5.5" fill="none" stroke="currentColor" strokeOpacity="0.3" />
        <path d="M19 12L13 15.0311V8.96891L19 12Z" fill="currentColor" fillOpacity="0.3" />
        <line x1="6" y1="12" x2="16" y2="12" stroke="currentColor" strokeOpacity="0.3" />
      </SvgIcon>
    );
  }
