...
import {
  ...
  VITAL_ORO_DISK_USAGE_PERCENTAGE,
  VITAL_ORO_DISK_USAGE_MB,
  ...
  onMessage = async (robotId, msg, _packet) => {
    ...
    try {
      ...
      const updates = {
        ...
        [VITAL_ORO_DISK_USAGE_PERCENTAGE]: { value: decodedMsg.oroHddUsagePercentage },
        [VITAL_ORO_DISK_USAGE_MB]: { value: decodedMsg.oroHddUsageMb },
