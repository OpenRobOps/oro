...
import '../imports/server/test/configAPI/configAPIIncidentDefinition.test.js'
import '../imports/server/test/configAPI/configAPINotificationChannel.test.js'
import '../imports/server/test/notificationChannelsManager.test.js'
import '../imports/server/test/incidentsCreation.test.js'
import '../imports/server/test/notificationsFromAlerts.test.js'
import '../imports/server/test/webhookClient.test.js'
import '../imports/server/test/alertsDistribution.test.js'
...
import '../imports/server/test/configAPI/configAPIRobotFootprint.test.js'
import '../imports/server/test/configAPI/configAPIRobotPath.test.js'
