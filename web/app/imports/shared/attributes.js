...
const VITAL_INORBIT_DISK_USAGE_PERCENTAGE = 'diskInOrbitUsagePercentage';
const VITAL_INORBIT_DISK_USAGE_MB = 'diskInOrbitUsageMb';
...
const VITAL_NET_INORBIT_TX_RATE = 'networkInOrbitTxRate';
const VITAL_NET_INORBIT_RX_RATE = 'networkInOrbitRxRate';
const VITAL_NET_INORBIT_RATE = 'networkInOrbitRate';
const VITAL_NET_TOTAL_TX_BYTES = 'networkTotalTxBytes';
const VITAL_NET_TOTAL_RX_BYTES = 'networkTotalRxBytes';
const VITAL_NET_INORBIT_TX_BYTES = 'networkInOrbitTxBytes';
const VITAL_NET_INORBIT_RX_BYTES = 'networkInOrbitRxBytes';
...
export {
  ...
  VITAL_INORBIT_DISK_USAGE_PERCENTAGE,
  VITAL_INORBIT_DISK_USAGE_MB,
  VITAL_NET_TOTAL_TX_RATE,
  VITAL_NET_TOTAL_RX_RATE,
  VITAL_NET_TOTAL_RATE,
  VITAL_NET_INORBIT_TX_RATE,
  VITAL_NET_INORBIT_RX_RATE,
  VITAL_NET_INORBIT_RATE,
  VITAL_NET_TOTAL_TX_BYTES,
  VITAL_NET_TOTAL_RX_BYTES,
  VITAL_NET_INORBIT_TX_BYTES,
  VITAL_NET_INORBIT_RX_BYTES,
  VITAL_SPEED_LINEAR,
  VITAL_SPEED_ANGULAR,
