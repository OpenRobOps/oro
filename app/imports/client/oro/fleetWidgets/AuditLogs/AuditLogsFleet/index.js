...
import AuditLogsFleet from './AuditLogsFleet';
import WithNoDataMessage from '../../../util/WithNoDataMessage';
import ZeroDataAuditLogs from '../AuditLogsRobot/ZeroDataAuditLogsRobot';

const FleetLog = props => <AuditLogsFleet {...props} />;
...
export default WithNoDataMessage(AuditLogsFleet, {
  ZeroDataComponent: ZeroDataAuditLogs,
  NoSelectionComponent: FleetLog
});
